...
pub fn main() {
    let file = File::open("/home/fanchao/Projects/Kogan.com-Android/kogan/build/tmp/kotlin-classes/auDebug/com/kogan/orderhistory/list/SapOrderItemStatus.class").expect("To open file");
